...
-- Set the undodir to save undo history in your Neovim config folder
...
vim.api.nvim_set_keymap('n', 'yd', ':lua vim.fn.setreg("+", vim.fn.expand("%:p:h"))<CR>', { noremap = true, silent = true })
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          file_ignore_patterns = {
            ...
            'build',
            'dist',
            'target', -- Add other folders you want to skip
          },
        },
        -- pickers = {}
        extensions = {
